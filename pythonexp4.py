# KEERTI GUPTA , IT-B  ROLLNO - 1900320130082
# Write a python program to find most frequent word in a  text file
file = open("inpy.txt","r")
frequent_word = ""
frequency = 0  
words = []
...
print("Most frequenteded word: " + frequent_word)
